      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Resubmit Cancelled Order</label>
              <input
                type="text"
                value={settings.trading.resubmit_cancelled_order}
                onChange={(e) => handleChange('trading', 'resubmit_cancelled_order', e.target.value)}
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              />
            </div>
            <div>
